    ...
    <div class="container px-3 px-lg-4">
      <div class="text-center">
        <p class="mb-0 fw-medium">
          ...
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="transform: translateY(-1px)" class="text-primary">
          ...
          <span>by <nuxt-link to="/">Yanuar Aditia</nuxt-link></span></p>
        <p class="fw-medium">Powered By <a href="//nuxtjs.org">Nuxt.js</a> & <a href="//getbootstrap.com">Bootstrap</a></p>
      </div>
    </div>
  </footer>
</template>
